...
```bash
python3 /Users/thierry/.agents/execution/follow_up_nurture.py --list-pending
```
...
```bash
python3 /Users/thierry/.agents/execution/follow_up_nurture.py --generate
```
...
```bash
# Review emails
python3 /Users/thierry/.agents/execution/follow_up_nurture.py --review

# Send emails
python3 /Users/thierry/.agents/execution/follow_up_nurture.py --send
```
